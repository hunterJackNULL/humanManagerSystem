...
<div class="data_list">
		...
		<form name="myForm" class="form-search" method="post" action="hrBuild?action=search">
				<button class="btn btn-success" type="button" style="margin-right: 50px;" onclick="javascript:window.location='hrBuild?action=preSave'">添加</button>
		...
		<div>
			<table class="table table-striped table-bordered table-hover datatable">
				<thead>
					...
					<tr>
						<td width="100px" height="30px"><input id="workId"   type="text" class="input-block-level" ></td>
						<td width="200px"><input  id="name"  type="text" class="input-block-level" ></td>
						<td width="300px"><input  id="introduction"  type="text" class="input-block-level" ></td>
